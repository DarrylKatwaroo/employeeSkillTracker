            ...
            <div class="col-md-9">
				...
				<form name="editDogForm" method="post" onsubmit="return(validate());" action="http://localhost/savePuppies/php/vet/updateDog.php" enctype="multipart/form-data">
					   ...
					   <div class="form-group">
							...
							<span class="text-danger"><?php if(!empty($errorName)){echo($errorName); }?></span>
					  ...
					  <div class="form-group">
							...
							<span class="text-danger"><?php if(!empty($errorHeight)){echo($errorHeight); }?></span>
					  </div>
					  
					  <div class="form-group">
							<label for="newWeight">Weight:</label>
							<input type="text"   name="newWeight" class="form-control" value="<?php echo $row['weight']; ?>">
							<span class="text-danger"><?php if(!empty($errorWeight)){echo($errorWeight); }?></span>
					  </div>
					   ...
					   <div class="form-group">
							...
							<span class="text-danger"><?php if(!empty($errorDesc)){echo($errorDesc); }?></span>
					  ...
					  <div class="form-group">
							...
							<span class="text-danger"><?php if(!empty($errorDF)){echo($errorDF); }?></span>
					  </div>
