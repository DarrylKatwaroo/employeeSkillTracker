...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Content Column -->
            <div class="col-md-9">
                <h2 class="page-header">View dog by ID or Name</h2>
		<div class="alert alert-warning alert-dismissible" role="alert">
									<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
									<i class="glyphicon glyphicon-exclamation-sign"></i>&nbsp;<strong>None selected.&nbsp;</strong>Please select an option from the list 
							  </div>		
