...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Content Column -->
            <div class="col-md-9">
                <h2 class="page-header">Edit Adopter</h2>
				<form method="post" action="http://localhost/savePuppies/php/clerk/regAdopter.php">
					   <fieldset>
						   <div class="form-group">
								<label for="name">First Name:</label>
								<input type="text" name="fname" class="form-control">
								<span class="text-danger"><?php if(!empty($errorFname)){echo($errorFname); }?></span>
						  </div>
						  <div class="form-group">
								<label for="name">Last Name:</label>
								<input type="text" name="lname" class="form-control">
								<span class="text-danger"><?php if(!empty($errorLname)){echo($errorLname); }?></span>
						  </div>
						   <div class="form-group">
								<label for="address">Address:</label>
								<input type="text" name="address" class="form-control">
								<span class="text-danger"><?php if(!empty($errorAddress)){echo($errorAddress); }?></span>
						  </div>
						  ...
						  <div class="form-group">
								...
								<span class="text-danger"><?php if(!empty($errorDOB)){echo($errorDOB); }?></span>
						  </div>
						  <div class="form-group">
								<label for="n_id">National ID:</label>
								<input type="text" name="n_id" class="form-control">
								<span class="text-danger"><?php if(!empty($errorNID)){echo($errorNID); }?></span>
						  </div>
						  <div class="form-group">
								<label for="email">Email:</label>
								<input type="text" name="email" class="form-control">
								<span class="text-danger"><?php if(!empty($errorEmail)){echo($errorEmail); }?></span>
						  </div>
						  <div class="form-group">
								<label for="contact">Contact No:</label>
								<input type="text" name="contact" class="form-control">
								<span class="text-danger"><?php if(!empty($errorContact)){echo($errorContact); }?></span>
						  </div>
					  </fieldset>
